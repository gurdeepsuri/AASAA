  ...
  app.innerHTML = `
    <aside class="sidebar">
      <div class="side-brand">
        <img src="../assets/mark.svg" alt="" class="side-mark">
        <div><div class="side-name">AASAA</div><div class="side-tag">Studio Manager</div></div>
      </div>
      <nav class="side-nav">
...
function needsUnlock() {
  return settings().passcode && sessionStorage.getItem('aasaa-unlocked') !== '1';
}
function showLock() {
  return new Promise((resolve) => {
    ...
    app.innerHTML = `
      <div class="lock">
        <img src="../assets/mark.svg" alt="" class="lock-mark">
        <h1>AASAA Studio</h1>
    ...
    form.addEventListener('submit', (e) => {
      ...
      if (val === settings().passcode) {
        sessionStorage.setItem('aasaa-unlocked', '1');
        resolve();
      } else {
